 ...
 * ==================================================================
 *
 * Добавлен модуль восстановления анимаций при переходах между сценами
 * и улучшенная защита от зависаний (ReplaceVAnimSmooth).
 *
 * При выходе в меню или при использовании кнопок анимации сохраняются
 * и автоматически восстанавливаются после возвращения на карту.
 * Для замены анимации без рывков используйте ReplaceVAnimSmooth.
 *
 * ==================================================================
 *
